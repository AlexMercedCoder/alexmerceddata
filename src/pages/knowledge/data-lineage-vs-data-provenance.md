...
This requirement for absolute traceability is satisfied by two closely related, but distinct, [Data Governance](/knowledge/data-governance) concepts: **[Data Lineage](/knowledge/data-lineage)** and **Data Provenance**.
...
2.  **The Extraction**: An Airflow job copied it to an [Amazon S3](/knowledge/amazon-s3) raw bucket.
...
3.  **Quality Metrics**: When it was ingested, it passed 99.8% of its automated [Data Quality](/knowledge/data-quality) checks.
