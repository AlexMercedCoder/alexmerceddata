...
2.  **Load**: The raw, untouched data is loaded *immediately* into the [Data Lakehouse](/knowledge/data-lakehouse) or Warehouse (often landing in the "Bronze" layer of a [Medallion Architecture](/knowledge/medallion-architecture)).
...
**When to use ELT:**
*   **Cloud [Data Lakehouses](/knowledge/data-lakehouse)**: When writing to S3/Iceberg tables, ELT is the default. Raw JSON/CSV is loaded into S3, and engines like [Apache Spark](/knowledge/apache-spark) or [Dremio](/knowledge/dremio) are spun up to transform the raw files into optimized Parquet/Iceberg formats.
