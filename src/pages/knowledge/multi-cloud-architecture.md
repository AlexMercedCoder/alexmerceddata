...
The **Open [Data Lakehouse](/knowledge/data-lakehouse)** is the key enabling technology for multi-cloud data architecture.
...
Moving petabytes of data across clouds incurs ruinous egress costs. Modern multi-cloud architectures rely on Virtual Data Warehouses and Federated Query Engines (like Trino or [Dremio](/knowledge/dremio)). 
