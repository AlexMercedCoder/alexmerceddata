...
The future of the Lakehouse is **Zero-ETL** (or the "Unified Analytical Database"). 
...
Because the data is stored in the universal Apache Iceberg format, and cataloged in an open standard (like the REST Catalog specification or Apache Polaris), the architecture will be entirely commoditized. 
