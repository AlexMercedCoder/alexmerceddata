...
Engines like **[Dremio](/knowledge/dremio)** and **Apache DataFusion** (built in Rust) use Arrow as their fundamental internal execution format. When Dremio reads a Parquet file from S3, it immediately converts the data into Arrow format in memory. All subsequent SQL aggregations, joins, and filters are executed directly on the Arrow memory buffers, resulting in blazing-fast execution.
